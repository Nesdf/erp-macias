...
Route::group(['middleware' => 'web', 'prefix' => 'mgreadpdf', 'namespace' => 'Modules\MgReadPdf\Http\Controllers'], function()
{
    ...
    Route::get('/lista-perosnajes/{folio}', 'MgReadPdfController@listaPersonajes')->name('lista_perosnajes');
    Route::post('/update-personaje', 'MgReadPdfController@updatePersonaje')->name('update_personaje');
});
