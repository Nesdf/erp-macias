...
class DepartamentoResponsableController extends Controller
{
    ...
    {
        $departamentoResponsable = DepartamentoResponsable::all();
        return view('mgcatalogos::departamento-responsable', compact('departamentoResponsable'));
    }
    ...
    public function create(Request $request)
    {
        try{
            if($request->isMethod('post')){
                ...
                $guardar = new DepartamentoResponsable();
    ...
    public function update(Request $request)
    {
        try{
            if($request->isMethod('post')){
                ...
                $guardar = DepartamentoResponsable::find($request->id);
                $guardar->nombre = $request->nombre;
                $guardar->descripcion = $request->descripcion;
